...
public class ExceptionControllerAdvice {
    ...
    @ExceptionHandler(NewGenException.class)
    public ResponseEntity<ErrorInfo> insuranceExceptionHandler(NewGenException exception) {
    ...
    public ResponseEntity<ErrorInfo> generalExceptionHandler(MailException exception) {
        LOGGER.error(exception.getMessage(), exception);
        ErrorInfo errorInfo = new ErrorInfo();
        errorInfo.setErrorCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
        errorInfo.setErrorMessage(environment.getProperty("General.MAIL_EXCEPTION_MESSAGE"));
